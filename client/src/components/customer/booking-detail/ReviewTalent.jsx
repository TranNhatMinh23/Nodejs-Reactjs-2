    ...
    render() {
        ...
        return (
            <div className="content-item review_customer">
                <p className="title">Talent’s Review </p>
                <p className="notify_review" style={{ fontWeight: gig.reviewed_by_entertainer && "700" }} >
                    {gig.reviewed_by_entertainer && gig.review_customer.length > 0 ? "Talent left the feedback" : "Talent didn’t leave the feedback"}
                </p>
                {
                ...
                <p className="notify_review" style={{ fontWeight: gig.reviewed_by_customer && "700" }}> {gig.reviewed_by_customer && gig.review_entertainer.length > 0 ? "You left the feedback" : "You didn’t leave the feedback"}</p>
                {
