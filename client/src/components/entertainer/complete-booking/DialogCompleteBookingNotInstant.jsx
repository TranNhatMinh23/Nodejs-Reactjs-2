...
class DialogCompleteBookingNotInstant extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: true,
  ...
  // totalPrice = (packageObj, addExtras) => {
          ...
          <div className="dialog-instant-content">
            ...
            <div className="instant-content">
              <div className="dialog-title">
                <h3>Great news your booking has been requested</h3>
                <p>
                  You will shortly receive confirmation and we will charge{" $"}
                  {dataBooking &&
...
export default withRouter(DialogCompleteBookingNotInstant);
